...
class _OrderService implements OrderService {
  ...
  @override
  Future<HttpResponse<dynamic>> getOrdersByStatus(
    String token,
    String status,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'order_status': status};
  ...
  @override
  Future<HttpResponse<dynamic>> getUserOrders(
    String token,
    String status,
  ) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> getOrderDetails(
    String token,
    String status,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'order_uuid': status};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
  ...
  @override
  Future<HttpResponse<dynamic>> getOrderPickupDelivery(
    String token,
    String status,
  ) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> doneOrder(
    String token,
    Map<String, dynamic> body,
  ) async {
    final _extra = <String, dynamic>{};
  ...
  Future<HttpResponse<dynamic>> createOrder(
    ...
    final _options = _setStreamType<HttpResponse<dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/User_Orders/checkout/create_order/',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<HttpResponse<dynamic>> addOrderDetails(
    String token,
    Map<String, dynamic> body,
  ) async {
    final _extra = <String, dynamic>{};
