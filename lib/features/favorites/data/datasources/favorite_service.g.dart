...
class _FavService implements FavService {
  _FavService(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  @override
  Future<HttpResponse<dynamic>> addFavoriteVendor(
    String token,
  ...
  @override
  Future<HttpResponse<dynamic>> getFavoriteVendor(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<HttpResponse<dynamic>> deleteFavoriteVendor(
    String token,
    Map<String, dynamic> body,
  ) async {
    final _extra = <String, dynamic>{};
