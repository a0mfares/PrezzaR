...
class _NotifyService implements NotifyService {
  _NotifyService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<HttpResponse<dynamic>> getNotifications(
    ...
    final queryParameters = <String, dynamic>{
      r'notification_type': notifyType,
      r'number_of_notifications': numOfNotify,
    };
  ...
  @override
  Future<HttpResponse<dynamic>> markAllNotification(String token) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
